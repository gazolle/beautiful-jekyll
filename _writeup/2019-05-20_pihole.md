...
*Scope*:    Installing Pi-Hole on my network and evaluate the outcome.  
*What*:     Pi-Hole is an primarily anapplication that blocks adverts (ads), trackers, and in-game ads; It is meant to operate at a network-level.  
*How*:      By configuring the firewall to forward all DNS request to the Pi-Hole.  
